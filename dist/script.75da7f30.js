...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../node_modules/tabletop/src/tabletop.js":[function(require,module,exports) {
var process = require("process");
var define;
(function () {
  'use strict';

  var inNodeJS = typeof process !== 'undefined' && !true;
...
},{"axios":"../node_modules/axios/index.js","process":"../node_modules/process/browser.js"}],"ass/static.gif":[function(require,module,exports) {
module.exports = "/static.c0bd65cb.gif";
...
exports.keys = void 0;
var keys = [// your keys here
"lA8GMp2G0BXaD50f5ksFyQqpzGasMrUl", "cqIxo6l4eeaYMkLcZPGJnQdMoP5V4zWT", "ukNYGeEVE3lvQjxZglDghcifIOyKCCHc", "5MFUOWfllMf4uBQSdt9EU5h3GfA5bTl2"];
exports.keys = keys;
},{}],"script.js":[function(require,module,exports) {
"use strict";

var _tabletop = _interopRequireDefault(require("tabletop"));

var _static = _interopRequireDefault(require("./ass/static.gif"));
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var newGif = function newGif() {
    var key = _keys.keys[counter % _keys.keys.length];
    var giphyURL = encodeURI(giphy.baseURL + giphy.type + "?api_key=" + key + "&tag=" + tag + "&rating=" + giphy.rating);
  ...
  var renderGif = function renderGif(_giphy) {
    // Set gif as bg image
    document.querySelector(".channel").style.backgroundImage = "url('" + _giphy.image_original_url + "')"; // Start duration countdown

    refreshRate();
  }; // Call for new gif after duration


  var refreshRate = function refreshRate() {
    // Reset set intervals
...
},{"tabletop":"../node_modules/tabletop/src/tabletop.js","./ass/static.gif":"ass/static.gif","./keys.js":"keys.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
